        ...
        <div className="cart">
          ...
          <div className="cart-container">
            <div className="cart-header">
              ...
              <h5 className="action" onClick={handleRemoveStorage}>Remove all</h5>
            </div>
            {cart.shoes.map((elem) => (
             <div className="cart-items">
                <div className="image-box">
                  <img src={elem.item.images[0].images} height="120px" width="120px"/>
                </div>
                <div className="about">
                  <h2 className="cart-product-title">{elem.item.title}</h2>
                <h3 className="cart-product-subtitle">{elem.item.category}</h3>
                <hr/>
                </div>
                ...
                <div className="prices">
                  <div className="prices">
                      ...
                      <div className="save"><u onClick={() => addProductToFavorites(elem.item)}>Favorites</u></div>
                      <div className="remove"><u onClick={() => removeProductToCart(elem.item)}>Remove</u></div>
                  </div>
                  <hr/>
                </div>
              </div>
